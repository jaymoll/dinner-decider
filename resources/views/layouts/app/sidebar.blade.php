        ...
        <flux:sidebar sticky collapsible="mobile" class="border-e border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:sidebar.nav>
                <flux:sidebar.group :heading="__('Platform')" class="grid">
                    ...
                    <flux:sidebar.item icon="squares-2x2" :href="route('ingredients.index')" :current="request()->routeIs('ingredients.*')" wire:navigate>
                        {{ __('Ingredients') }}
                    </flux:sidebar.item>
                    ...
                    <flux:sidebar.item icon="sparkles" :href="route('decisions.index')" :current="request()->routeIs('decisions.*')" wire:navigate>
                        {{ __('Decision Mode') }}
                    </flux:sidebar.item>
