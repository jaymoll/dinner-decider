...
See the [codebase guide](docs/codebase-guide.md), [architecture](docs/architecture.md), [MVP release checklist](docs/mvp-release-checklist.md), and [operations runbook](docs/operations-runbook.md). Detailed production deployment, backup, restore, and rollback procedures live in the runbook rather than this development setup guide.
